...
\
Suppose we hypothesize that: "Women will be more likely than men to think that the government should do more to address climate change." Then, using data from the 2016 American National Election Study Pilot (ANES), we find that between the male and female sexes, respondents felt that
...
where "Do Less" indicates that the respondent feels the government should do less about climate change and "Do More" indicates that the respondent feels the government should do more about climate change. As such, we can see that approximately 65% of men selected "Do More" compared to 79% of women. \
\
<!--  To test whether these results are statistically significant, or merely due to chance alone, we must formulate a null hypothesis: "Women will be no more likely than men to think that the government should do more to address climate change." -->
...
\
Given degrees of freedom and level of significance, if one's determined chi squared value is less than its corresponding value on the Chi-squared distribution table, no relationship was found between variables. The results were probably due to chance alone. <!--In this case, one should accept the null hypothesis if one was advanced.--> Conversely, if one's determined chi squared value is greater than its corresponding value on the Chi-squared distribution table, the relationship between variables was statistically significant. <!--In this case, one should reject null the hypothesis if a null hypothesis was advanced. --> \
\
In our previous example using ANES data, given that we found the sample's chi squared value is 24.486299 with 1 degree of freedom, we can see that results from the ANES data were significant at the .001 level. This means that the probability that the observed results are due to chance alone is less than .1%. Then, recall that a greater percentage of women than men responded "Do More" when asked if the government should do more to combat climate change. As such, we can conclude that the probability that women in the sample are more likely than men in the sample to think that the government should do more to address climate change is due to chance alone is less than .1%. \
\
