...
[Regression Solver and Computing Best OLS Fit](https://nathanenglehart.github.io/projects/regression)***
Implementation of a regression solver that uses cross-validation to find the best OLS fit.
<br />
[K-nearest-neighbors with K-fold Cross-validation](https://nathanenglehart.github.io/projects/knn)***
